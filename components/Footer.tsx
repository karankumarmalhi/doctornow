    ...
    <footer className="bg-gray-100">
        <div className="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
            ...
            >
                ...
                <li>
                <a className="text-gray-700 transition hover:text-primary" href="/doctors"> Doctors </a>
                </li>

                <li>
                <a className="text-gray-700 transition hover:text-primary" href="/"> My Appointment </a>
                </li>

                <li>
                <a className="text-gray-700 transition hover:text-primary" href="/blog"> Blog </a>
                </li>
            </ul>
            </div>
